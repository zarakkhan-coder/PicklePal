    ...
    <>
      ...
      <div className="pp-wrap">
        <div className="pp-card">
          ...
          <p className="pp-copy">
            You can vote more than once; we’ll use the majority each week. Players who
            enter an email will receive reminders.
          </p>
      ...
      <style jsx>{`
        ...
        .b1 { left: 8%;  bottom: -50px; animation-duration: 19s; }
        .b2 { left: 50%; bottom: -60px; animation-duration: 21s; }
        .b3 { right: 7%; bottom: -55px; animation-duration: 17s; }

        .paddle { font-size: 44px; animation: slow-sway 9s ease-in-out infinite; }
        .pd1 { right: 6%; top: 12%; transform: rotate(-18deg); }
        .pd2 { left: 6%;  top: 22%; transform: rotate(14deg); }
        ...
        input, select {
          ...
          border-radius:10px; border:1px solid #244b6b;
          background:#0b1b2a; color:#eaf6ff; outline:none;
        }
        ...
        .pp-btn {
          ...
          border:none; border-radius:10px; color:#03121d; font-weight:800;
          letter-spacing:.3px; cursor:pointer;
          transform:translateY(0);
          transition: transform 160ms ease, box-shadow 160ms ease;
          box-shadow: 0 6px 14px rgba(0,0,0,.25);
        }
        .pp-btn:hover { transform: translateY(-2px); box-shadow: 0 10px 18px rgba(0,0,0,.32); }
